...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-pointer items-center rounded-md px-2 py-1.5 text-sm outline-none select-none data-[inset]:pl-8",
        "data-[highlighted]:bg-accent/10 data-[state=open]:bg-accent/10",
        className,
      )}
      {...props}
    >
